...
// Moved to `crate::rust_lex` once a FOURTH scanner needed it — the Structure
// tab lives in `panels`, which cannot reach into this module. Re-exported
// rather than relocated at the call sites so `super::generics::code_mask`
// keeps resolving for the two consumers inside this module.
pub(super) use crate::rust_lex::code_mask;
