...
fn token_to_function(tok: &str) -> Option<PinFunction> {
    ...
    match word {
        ...
        "i2s" => match tail {
            ...
            "pcnt_edge" => Some(PinFunction::PcntEdge(n)),
            "pcnt_ctrl" => Some(PinFunction::PcntCtrl(n)),
...
fn function_to_token(f: &PinFunction) -> Option<String> {
    Some(match f {
        ...
        PinFunction::LcdCamHenable => "lcd_href".to_owned(),
        PinFunction::LcdCamMclk => "lcd_mclk".to_owned(),
