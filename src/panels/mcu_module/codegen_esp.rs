...
fn hal_line(mcu_name: &str, runtime: EspRuntime) -> String {
    ...
    let hal = crate::panels::mcu_module::project_gen::ESP_HAL_REQ.trim_start_matches(['~', '^', '=']);
    let rtos = crate::panels::mcu_module::project_gen::ESP_RTOS_REQ;
    match runtime {
        EspRuntime::Blocking => format!("{HAL_LINE_PREFIX}{mcu_name} | HAL: esp-hal {hal} (blocking)\n"),
        EspRuntime::Async => {
...
mod tests {
    ...
    fn hal_header_line_tracks_version_and_runtime() {
        ...
        let banner = updated.find("// Auto-generated by Embedded IDE").expect("banner");
